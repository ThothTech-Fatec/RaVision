...
## 🎯 Meta da Sprint
Evoluir o sistema com controle de acesso, criação inteligente de regras via IA, fluxo de auditoria e aplicação de cenários avançados de cálculo (multi-loja, afastamentos e bônus), além de explicações detalhadas dos resultados.
...
**User Story (#8):** Como Analista de Operações, quero identificar funcionários que trabalharam em mais de uma loja no mês, para cálculo proporcional correto.  
**Estimativa:** 8 Story Points  
...
**User Story (#9):** Como Analista de Operações, quero aplicar regras de afastamento médico, para garantir conformidade com a legislação trabalhista.  
**Estimativa:** 13 Story Points  
...
**User Story (#11):** Como Analista de Operações, quero entender como o valor foi calculado, para justificar resultados.  
**Estimativa:** 13 Story Points  
